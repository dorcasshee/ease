...
#Preview {
    ...
    let trsn = Transaction(amount: 1000, category: SubCategory(id: "preview-sub", name: "Salary", iconName: "dollar", isSystemIcon: true, isDefault: false, parent: parent), transactionType: .income, desc: "Salary", payee: Payee(name: "Company A"), date: Date())
