...
//  Ease
//
//  Created by Dorcas Shee on 24/9/26.
//
...
struct LogIncomeIntent: AppIntent {
    static var title: LocalizedStringResource = "Add New Income Transaction to Ease"
    static var description = IntentDescription("Logs money received to Ease.")

    @Parameter(title: "Amount", description: "Transaction amount.")
    var amount: Double

    @Parameter(title: "Paid By", description: "Person/entity who paid you.")
...
""")
    ...
    func perform() async throws -> some IntentResult {
        ...
        let uncategorizedID = "scat.income.uncategorized.uncategorized"
        ...
        let trimmedPayeeName = payerName?.trimmingCharacters(in: .whitespacesAndNewlines) ?? ""
